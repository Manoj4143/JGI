...
if ($info['dept_id'] == '1') {
    header("Location: Education/index.php?username=" . urlencode($_POST['username']));
    exit;
} elseif ($info['dept_id'] == '2') {
    header("Location: CIT/index.php?username=" . urlencode($_POST['username']));
    exit;
} elseif ($info['dept_id'] == '3') {
    header("Location: SAS/index.php?username=" . urlencode($_POST['username']));
    exit;
} elseif ($info['dept_id'] == '4') {
    header("Location: Admin/admin.php?username=" . urlencode($_POST['username']));
    exit;
} else {
